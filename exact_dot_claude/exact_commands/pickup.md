...
1. Glob for `.claude/session-handoff-*.md` in the project root. If `$ARGUMENTS` is provided, pick the handoff whose subject matches. Otherwise pick the latest by timestamp.
